                                                    ...
                                                    <div class="col-md-6" >
                                                        <div class="form-group mt-1">
                                                           <select name="parent_id" id="">
                                                            @foreach ($main_categories as  $main_catigory)
                                                                <option value="{{$main_catigory->id}}"> {{$main_categories->category_name}} @if($main_catigory->id == $category->parent_id)  selected @endif </option>
                                                            @endforeach
                                                           </select>
