                                                    ...
                                                    <div class="col-md-6" >
                                                        <div class="form-group mt-1">
                                                           <select name="parent_id" id="">
                                                            @foreach ($main_catigories as  $main_catigory)
                                                                <option value="{{$main_catigories->id}}"> {{$category->category_name}} @if($main_catigories->id == $category->parent_id)  selected @endif </option>
                                                            @endforeach
                                                           </select>
