...
class SubCategoriesController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.maincategories.edit', compact('category', 'local' , 'main_catigories'));
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        return redirect()->route('SubCategories.index')->with(['success' => "categoy deleted succefuly "]);
    }
}
