            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="Email" class="col-md-4 col-form-label text-md-right">Eamil </label>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="social_title" class="col-md-4 col-form-label text-md-right">{{ __('Social Title') }}</label>

                            <div class="col-md-6">
                                <select id="social_title" class="form-control @error('social_title') is-invalid @enderror" name="social_title" value="{{ old('social_title') }}" required autocomplete="social_title" autofocus>
