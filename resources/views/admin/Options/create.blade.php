                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('options.store')}}"
                                              method="POST"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم الاضافة  </label>
                                                                ...
                                                                <div class="form-group mt-1">
                                                                   <select name="product_id" id="">
                                                                    ...
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">اختر المنتج   </label>
                                                            ...
                                                            <div class="col-md-6" >
                                                                <div class="form-group mt-1">
                                                                   <select name="attribute_id" id="">
                                                                    ...
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">choose attribute   </label>
